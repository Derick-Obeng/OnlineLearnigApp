    ...
    return (
        <ScrollView>
            <View style={{ display: 'flex', alignItems: 'center', marginTop: 25, marginBottom: 25 }}>
                {[
                    {
                        title: "African Studies v1.0",
                        author: "Robbertson Connie",
                        price: "$1000",
                        duration: "116 hours",
                    },
                    {
                        title: "Introduction to Python v1.0",
                    ...
                    <TouchableOpacity key={index}>
                        <View style={styles.course}>
                            ...
                            <View style={styles.details}>
                                ...
                                <Text style={{ fontWeight: '400', color: "rgba(184, 184, 210, 1)", fontSize: 12, padding: 5 }}>
                                    <FontAwesome5 name="user-alt" size={12} style={{ color: "rgba(184, 184, 210, 1)" }} />
                                    {course.author}
                                </Text>
