    ...
    <View style={{display:'flex',alignItems:'center',marginTop:25,
        ...
        <View style={styles.course}>
            ...
            <View style={styles.details}>
                <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}>Product Design v1.0</Text>
            ...
            <View style={{display:'flex', flexDirection:'row'}}>
                ...
                <Text style={{color:'rgba(255, 105, 5, 1)',fontSize:10, backgroundColor:"rgb(233, 202, 182)",fontWeight:400,borderRadius:10,padding:5,marginLeft:10}}>16 hours</Text>
            </View>
            </View>
            </View>
        </TouchableOpacity>
        ...
        <View style={styles.course}>
            ...
            <Image  source={require('../assets/profileImage.png')} style={{marginLeft:20,padding:30,borderRadius:10}}/>
            <View style={styles.details}>
                <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}>Java Development v1.0</Text>
