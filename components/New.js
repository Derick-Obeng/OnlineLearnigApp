        ...
        <View style={{display:'flex',alignItems:'center',marginTop:25,
            ...
            <View style={styles.course}>
                ...
                <View style={styles.details}>
                    <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}>Machine Learning v1.0</Text>
            ...
            <View style={styles.course}>
                ...
                <Image  source={require('../assets/profileImage.png')} style={{marginLeft:20,padding:30,borderRadius:10}}/>
                <View style={styles.details}>
                    <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}>Affiliate Marketing v1.0</Text>
                ...
                <View style={{display:'flex', flexDirection:'row'}}>
                    ...
                    <Text style={{color:'rgba(255, 105, 5, 1)',fontSize:10, backgroundColor:"rgb(233, 202, 182)",fontWeight:400,borderRadius:10,padding:5,marginLeft:10}}>2 hours</Text>
                </View>
                </View>
                </View>
            </TouchableOpacity>
            ...
            <View style={styles.course}>
                ...
                <Image  source={require('../assets/profileImage.png')} style={{marginLeft:20,padding:30,borderRadius:10}}/>
                <View style={styles.details}>
                    <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}> Science v1.0</Text>
                    <Text style={{fontWeight:400,color:"rgba(184, 184, 210, 1)", fontSize:12,padding:5}}><FontAwesome5 name="user-alt" size={12} style={{color:"rgba(184, 184, 210, 1)"}} />Robbertson Markin</Text>
                <View style={{display:'flex', flexDirection:'row'}}>
                    <Text style={{color:'rgba(61, 92, 255, 1)',fontSize:16,fontWeight:700}}>
            ...
            <View style={styles.course}>
                ...
                <Image  source={require('../assets/profileImage.png')} style={{marginLeft:20,padding:30,borderRadius:10}}/>
                <View style={styles.details}>
                    <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}>Bussiness Administrator v1.0</Text>
                ...
                <View style={{display:'flex', flexDirection:'row'}}>
                    ...
                    <Text style={{color:'rgba(255, 105, 5, 1)',fontSize:10, backgroundColor:"rgb(233, 202, 182)",fontWeight:400,borderRadius:10,padding:5,marginLeft:10}}>11 hours</Text>
                </View>
                </View>
                </View>
            </TouchableOpacity>
            ...
            <View style={styles.course}>
                ...
                <Image  source={require('../assets/profileImage.png')} style={{marginLeft:20,padding:30,borderRadius:10}}/>
                <View style={styles.details}>
                    <Text style={{fontWeight:500, fontSize:14, color:"rgba(31, 31, 57, 1)"}}>Introduction To structural Engineering v1.0</Text>
